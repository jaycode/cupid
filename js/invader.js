var SCRIPTURL = 'http://localhost/cupid/js/';
var IMAGESURL = 'http://localhost/cupid/images/';
var POSTURL = 'http://localhost/cupid/';

var FACEBOOKPOSTTITLE = 'Cupid Shooter';
var FACEBOOKPOSTSUMMARY = 'Shoot web page into bits n’ pieces';
var ieInstruction = 'Right click on cupid, press add to favorites';
var ieNote = 'Internet Explorer not supported';


var TWITTERPOSTTITLE = 'Cupid game twitter';
var spaceShipImgSrcs = ['cupid_11.png', 'cupid_12.png', 'cupid_13.png'];
var bulletImgSrcs = ['bullet_01.png', 'bullet_02.png', 'bullet_03.png', 'bullet_04.png', 'bullet_05.png'];
var message = null;
...
(function() {
  function Invaders() {
    ...
    for(var bi = 0; bi < bulletImgSrcs.length; bi++){
      ...
      console.log('trying to get bullet number ' + bi);
    ...
    if ( ! document.getElementById('INVADERS-NAVIGATION') ) {
      ...
      //http://www.facebook.com/share.php?u=http://mmspaceship.bbdo.sutrix.com/20110214cssversion/

      this.navigation.innerHTML = '' +
          '<p style="line-height: 24px; padding: 3px 0pt 5px; margin: 0; color: #888">' +
          '(press esc to quit)' +
          '<strong id="INVADERS-POINTS" style="padding-left: 5px; font-size: 3em;">0</strong>' +
          '</p>' +
          '<p style="line-height: 24px; padding: 3px 0pt 5px; margin: 0">' +
          '<a style="color: #fff;" onclick="return facebookPost(\'' + POSTURL + '\', \'' + FACEBOOKPOSTTITLE +'\', \'' + IMAGESURL + 'logo_mm.png' + '\', \'' + FACEBOOKPOSTSUMMARY + '\');" href="javascript:void(0);">' +
          '<img alt="Share" style="margin-left: 8px" src=" ' + IMAGESURL + 'f_share.png">' +
          '</a>' +
          '<a style="color: #fff;" href="http://twitter.com/home?status=' + escape(TWITTERPOSTTITLE) + ' ' + POSTURL + '" target="_blank">' +
          '<img alt="Tweet" style="margin-left: 8px" src="' + IMAGESURL + 'tweet.png">' +
          '</a>' +
          '</p>';
    ...
    this.update = function() {
      ...
      if ( this.keysPressed[code(' ')] && nowTime - this.firedAt > timeBetweenFire ) {
        this.bullets.unshift({
          ...
          'cameAlive': nowTime,
          'type': random(0, bulletImgSrcs.length-1)
        });
  ...
  window.preloadImage = function(){
    var preloadImgs = spaceShipImgSrcs.concat(bulletImgSrcs);
